function GetEmoji() {
  return (
    <div className="max-w-full bg-hero-3 mx-auto h-full block px-[100px] sm:px-[0.9375rem] md:px-[3.375rem] py-[16.875rem] sm:py-[6.125rem] bg-cover bg-no-repeat bg-[length:100%_100%] scroll-smooth  after-content=[''] after:absolute after:w-full after:h-[25rem] after:bg-green after:left-0 after:right-0 after:-z-10">
      ...
      <div className="flex justify-center items-stretch my-[40px] sm:my-[0] gap-3 sm:flex-col md:flex-col max-w-full relative">
        <div className="p-[40px] sm:p-[10px] flex-[0_0_50%] sm:flex-[0_0_100%] md:flex-[0_0_100%] sm:max-w-full">
          <div className="bg-white rounded-lg overflow-hidden w-full drop-shadow-3xl">
            <div className="bg-hero-4 bg-top-center bg-no-repeat bg-cover bg-[length:100%_100%] w-full">
